...
function NavButton({ icon, label, onClick, disabled, active }: NavButtonProps) {
  ...
  return (
    <button
      ...
      className={`relative flex w-full items-center gap-2.5 rounded-xl px-2.5 py-1.5 transition-colors duration-75 ${
        disabled
                    ...
                    {chats.map((chat) => {
                      ...
                      return (
                        ...
                        <div
                          ...
                          className="group relative flex min-w-0 cursor-pointer items-center rounded-xl px-2.5 py-1.5 transition-colors duration-75 hover:bg-fill-hover"
                          style={{ isolation: "isolate" }}
                        >
                          {active && (
                            <motion.div
