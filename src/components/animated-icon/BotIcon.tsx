...
const BotIcon = forwardRef<BotIconHandle, BotIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      <>
        {/* biome-ignore lint/a11y/noStaticElementInteractions: hover-only decorative animation */}
        <div
        ...
        >
          ...
          >
            ...
            <motion.line
              ...
              x2={15}
            />
            <motion.line animate={controls} initial="normal" variants={eyeVariants} x1={9} x2={9} />
          </svg>
        </div>
      </>
    );
