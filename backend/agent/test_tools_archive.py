...
class TestArchive:
	async def test_create_and_list_zip(self, tmp_workspace):
		...
		t = ArchiveTool()
		r = await t.execute({
			"action": "create", "path": "out.zip", "sources": ["a.txt", "b.txt"],
		})
	...
	async def test_extract_zip(self, tmp_workspace):
		...
		t = ArchiveTool()
		r = await t.execute({
			"action": "extract", "path": "src.zip", "dest": "out",
		})
	...
	async def test_create_tar_gz_and_list(self, tmp_workspace):
		...
		t = ArchiveTool()
		r = await t.execute({
			"action": "create", "path": "out.tar.gz", "sources": ["x.txt"],
		})
	...
	async def test_zip_slip_blocked(self, tmp_workspace):
		...
		t = ArchiveTool()
		r = await t.execute({
			"action": "extract", "path": "evil.zip", "dest": "out",
		})
	...
	async def test_extract_outside_workspace_blocked(self, tmp_workspace):
		...
		t = ArchiveTool()
		r = await t.execute({
			"action": "extract", "path": "ok.zip", "dest": "..",
		})
